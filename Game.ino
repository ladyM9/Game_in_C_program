...
const myline_t myLab2[] = {{4, 4, 132, 4}, {164, 4, 320, 4}, {320, 36, 228, 18}, {130, 18, 162, 18}, {66, 34, 146, 34}, {18, 50, 50, 50}, {82, 50, 98, 50}, {114, 50, 162, 50} , {50, 66, 66, 66}, {98, 66, 146, 66}, {18, 82, 34, 82}, {50, 82, 82, 82}, {146, 82, 162, 82}, {2, 98, 34, 98}, {82, 98, 130, 98}, {146, 98, 162, 98}, {66, 114, 114, 114}, {130, 114, 146, 114}, {50, 130, 66, 130} , {146, 130, 162, 130}, {18, 146, 98, 146}, {130, 146, 146, 146}, {2, 162, 82, 162}, {98, 162, 162, 162}, {2, 2, 2, 162}, {18, 18, 18, 66}, {18, 114, 18, 146}, {34, 2, 34, 34}, {34, 66, 34, 130}, {50, 18, 50, 130}, {66, 18, 66, 50}, {66, 98, 66, 114}, {66, 130, 66, 146}, {82, 2, 82, 18}, {82, 50, 82, 98}, {82, 114, 82, 130}, {82, 146, 82, 162}, {98, 50, 98, 82}, {98, 130, 98, 146}, {114, 34, 114, 50}, {114, 82, 114, 98}, {114, 114, 114, 162}, {130, 66, 130, 82}, {130, 98, 130, 146}, {162, 2, 162, 162}};
...
const myline_t myLab5[] = { { 128, 1, 163, 1 }};
const myline_t myLab6[] = { {2, 2, 82, 2} , {98, 2, 178, 2} , {34, 18, 50, 18} , {98, 18, 146, 18}, {18, 34, 50, 34}, {66, 34, 98, 34}, {130, 34, 162, 34}, {2, 50, 18, 50}, {50, 50, 66, 50}, {98, 50, 114, 50}, {18, 66, 34, 66}, {66, 66, 82, 66}, {130, 66, 146, 66}, {162, 66, 178, 66}, {2, 82, 18, 82}, {50, 82, 66, 82}, {82, 82, 98, 82}, {114, 82, 130, 82}, {146, 82, 162, 82}, {2, 98, 34, 98}, {66, 98, 98, 98}, {114, 98, 162, 98}, {18, 114, 50, 114}, {66, 114, 82, 114}, {98, 114, 114, 114}, {162, 114, 178, 114}, {2, 130, 82, 130}, {98, 130, 178, 130}, {2, 2, 2, 130}, {18, 18, 18, 34}, {34, 34, 34, 98}, {50, 18, 50, 34}, {50, 50, 50, 82}, {50, 98, 50, 130}, {66, 18, 66, 50}, {66, 82, 66, 98}, {82, 2, 82, 18}, {82, 34, 82, 66}, {82, 114, 82, 130}, {98, 18, 98, 34}, {98, 66, 98, 130}, {114, 18, 114, 66}, {114, 82, 114, 98}, {130, 34, 130, 50}, {130, 66, 130, 82}, {130, 98, 130, 130}, {146, 50, 146, 66}, {146, 114, 146, 130}, {162, 2, 162, 50}, {162, 66, 162, 82}, {178, 2, 178, 130}};
const myline_t *myLabs[] = {myLab1 , myLab2, myLab3, myLab4, myLab5, myLab6};
...
void setup() {
  ...
  for ( int i = 0 ; i < 51 ; i++) //petlja za iscrtavanje svih linija u labirintu
  {
    int j1 = myLabs[5][i].x0 * 1.75;
    int j2 = myLabs[5][i].y0 * 1.75;
    int j3 = myLabs[5][i].x1 * 1.75;
    int j4 = myLabs[5][i].y1 * 1.75; 
...
void loop() {
  ...
  if (ref == true) {
    ...
    for ( int i = 0 ; i < 51 ; i++) //petlja za iscrtavanje svih linija u labirintu
    {
      display.drawLine(myLabs[5][i].x0 * 1.75, myLabs[5][i].y0 * 1.75, myLabs[5][i].x1 * 1.75, myLabs[5][i].y1 * 1.75, col == 0 ? ILI9341_WHITE : ILI9341_RED);
      //      display.drawLine(myLabs[0][i].x0, myLabs[0][i].y0, myLabs[0][i].x1, myLabs[0][i].y1, ILI9341_WHITE);
      //display.drawLine(myLabs[1][i].x0, myLabs[1][i].y0, myLabs[1][i].x1, myLabs[1][i].y1, ILI9341_BLACK);
    }
