...
const myline_t myLab2[] =  {{2, 2, 66, 2}, {82, 2, 162, 2}, {82, 18, 114, 18}, {130, 18, 162, 18}, {66, 34, 146, 34}, {18, 50, 50, 50}, {82, 50, 98, 50}, {114, 50, 162, 50}, {50, 66, 66, 66}, {98, 66, 146, 66}, {18, 82, 34, 82}, {50, 82, 82, 82}, {146, 82, 162, 82}, {2, 98, 34, 98}, {82, 98, 130, 98}, {146, 98, 162, 98}, {66, 114, 114, 114},  {130, 114, 146, 114}, {50, 130, 66, 130}, {146, 130, 162, 130}, {18, 146, 98, 146},  {130, 146, 146, 146}, {2, 162, 82, 162}, {98, 162, 162, 162} ,  {2, 2, 2, 162}, {18, 18, 18, 66}, {18, 114, 18, 146}, {34, 2, 34, 34}, {34, 66, 34, 130}, {50, 18, 50, 130}, {66, 18, 66, 50}, {66, 98, 66, 114}, {66, 130, 66, 146}, {82, 2, 82, 18}, {82, 50, 82, 98}, {82, 114, 82, 130}, {82, 146, 82, 162}, {98, 50, 98, 82}, {98, 130, 98, 146}, {114, 34, 114, 50},  {114, 82, 114, 98}, {114, 114, 114, 162}, {130, 66, 130, 82}, {130, 98, 130, 146}, {162, 2, 162, 162}}; //novi lab
const myline_t myLab3[] = {{6 , 6, 102, 6} , { 150, 6, 246, 6} , {150, 54, 66, 198}, {6, 102, 198, 102}, {54, 150, 150, 150}, {54, 198, 102, 198} , {198, 198, 246, 198} , {6, 246, 102, 246 } , {150, 246, 246, 246}, {6, 6, 6, 246} , {54, 6, 54, 54}, {102, 54, 102, 102}, {102, 198, 102, 246} ,  {150, 150, 150, 246} , {198, 54, 198, 150}, {246, 6, 246, 246}};
const myline_t myLab4[] = {{0, 0, 340, 0 } , {126, 0, 249, 0} , {0, 0, 0, 141} , {0, 141, 123, 141} , {150, 141, 249, 141}, {249, 141, 249, 0} , {1, 27, 18, 27} , {27, 15, 48, 15} , {51, 15, 51, 42}, {24, 42, 17, 42} , {24, 42, 24, 69} , {24, 69, 51, 69}, {51, 69, 51, 126}, {3, 84, 24, 84}, {84, 84, 24, 111}, {75, 3, 75, 81}, {57, 57, 72, 57} , {54, 99, 96, 99} , {75, 114, 75, 138} , {99, 15, 99, 141}, {102, 27, 150, 27} , {150, 27, 150, 42}, {126, 42, 150, 42} , {126, 36, 126, 54} , {174, 15, 174, 57} , {153, 57, 174, 57}, {150, 57, 150, 69}, {141, 69, 150, 69}, {177, 42, 198, 42}, {99, 3, 99, 42}, {225, 15, 225, 69} , {201, 84, 225, 69}, {99, 66, 198, 99}, {225, 84, 225, 84} , {126, 84, 195, 84} , {126, 84, 126, 111}, {198, 99, 222, 99} , {102, 114, 147, 114} , {150, 99, 174, 99}, {174, 99, 174, 114}, {174, 114, 249, 114}, {135, 129, 198, 129}, {147, 129, 147, 141}};
const myline_t myLab5[] = { {2, 2, 82, 2} , {98, 2, 178, 2} , {34, 18, 50, 18} , {98, 18, 146, 18}, {18, 34, 50, 34}, {66, 34, 98, 34}, {130, 34, 162, 34}, {2, 50, 18, 50}, {50, 50, 66, 50}, {98, 50, 114, 50}, {18, 66, 34, 66}, {66, 66, 82, 66}, {130, 66, 146, 66}, {162, 66, 178, 66}, {2, 82, 18, 82}, {50, 82, 66, 82}, {82, 82, 98, 82}, {114, 82, 130, 82}, {146, 82, 162, 82}, {2, 98, 34, 98}, {66, 98, 98, 98}, {114, 98, 162, 98}, {18, 114, 50, 114}, {66, 114, 82, 114}, {98, 114, 114, 114}, {162, 114, 178, 114}, {2, 130, 82, 130}, {98, 130, 178, 130}, {2, 2, 2, 130}, {18, 18, 18, 34}, {34, 34, 34, 98}, {50, 18, 50, 34}, {50, 50, 50, 82}, {50, 98, 50, 130}, {66, 18, 66, 50}, {66, 82, 66, 98}, {82, 2, 82, 18}, {82, 34, 82, 66}, {82, 114, 82, 130}, {98, 18, 98, 34}, {98, 66, 98, 130}, {114, 18, 114, 66}, {114, 82, 114, 98}, {130, 34, 130, 50}, {130, 66, 130, 82}, {130, 98, 130, 130}, {146, 50, 146, 66}, {146, 114, 146, 130}, {162, 2, 162, 50}, {162, 66, 162, 82}, {178, 2, 178, 130}}; //ispravan lab
const myline_t myLab6[] = { {2, 2, 82, 2}, {98, 2, 178, 2}, {2, 18, 34, 18}, {50, 18, 82, 18}, {98, 18, 114, 18}, {130, 18, 146, 18}, {18, 34, 98, 34}, {114, 34, 130, 34}, {146, 34, 162, 34}, {18, 50, 114, 50}, {130, 50, 146, 50}, {18, 66, 66, 66}, {114, 66, 130, 66}, {146, 66, 162, 66}, {66, 82, 82, 82}, {98, 82, 146, 82}, {18, 98, 34, 98}, {82, 98, 130, 98}, {18, 114, 82, 114}, {130, 114, 162, 114}, {2, 130, 82, 130}, {98, 130, 178, 130}, {2, 2, 2, 130}, {18, 82, 18, 114}, {34, 66, 34, 82}, {50, 2, 50, 18}, {50, 66, 50, 98}, {66, 50, 66, 66}, {66, 82, 66, 98}, {82, 66, 82, 130}, {98, 2, 98, 34}, {98, 66, 98, 82}, {98, 114, 98, 130}, {114, 50, 114, 66}, {114, 98, 114, 114}, {130, 18, 130, 66}, {130, 82, 130, 98}, {130, 114, 130, 130}, {146, 2, 146, 18}, {146, 66, 146, 82}, {146, 98, 146, 114}, {162, 18, 162, 66}, {162, 82, 162, 114}, {178, 2, 178, 130}}; //ispravan lab
const myline_t myLab7[] = { { 128, 1, 163, 1 }};
const myline_t *myLabs[] = {myLab1 , myLab2, myLab3, myLab4, myLab5, myLab6, myLab7};
