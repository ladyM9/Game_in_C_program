...
void loop() {
  ...
  if (ref == true) {
    ...
    int col = checkCollision(OBJECT1 , myLabs[4], 63);
    ...
    if ( col == 0)
    {
      drawLines(myLabs[4], 49 , ILI9341_WHITE);

    }
    if ( col != 0)
    {
      drawLines(myLabs[4], 49 , ILI9341_RED);
    }
    if ( col_1 != 0)
    {
      //display.clearDisplay();
