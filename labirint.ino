//moras napravit dozvoljenu, ne dozvoljenu koliziju
#include <SPI.h>
...
int m1 = 13;
int n2 = 50;
int m2 = 13; //prva crta horizontlna

int n3 = 30;
int m3 = 13;
int n4 = 30;
int m4 = 23; // druga crta(vertikalna)

int n5 = 30;
int m5 = 23;
int n6 = 37;
int m6 = 23; // treca crta(horizontalna)

int n7 = 45;
int m7 = 23;
int n8 = 60;
int m8 = 23; // cetvrta crta(horizontalna)

int n9 = 37;
int m9 = 23;
int n10 = 37;
int m10 = 30; //peta crta

int n11 = 37;
int m11 = 30;
int n12 = 50;
int m12 = 30; //šesta crta(horizontalna)
...
void loop() {
  ...
  if (ref) {
    ...
    display.drawLine ( n13, m13 , n14, m14, BLACK);
    display.drawLine (n15, m15, n16, m16, BLACK);
    display.drawLine ( n17, m17, n18, m18, BLACK);
    display.drawLine (n19, m19, n20, m20, BLACK);
...
void collided_with(struct OBJECT o, struct RECT r, struct  DISTANCE d, struct LINE l) {
  ...
  if (_collisionDetected) {
    ...
    display.print("Crta dotaknuta, pomakni se " );
    display.display();
    if (analogRead(A0)) {
      display.clearDisplay();
    }
